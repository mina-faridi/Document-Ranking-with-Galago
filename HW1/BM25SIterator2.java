...
public class BM25SIterator2 extends ScoringFunctionIterator implements DeltaScoringIterator {
  ...
  public BM25SIterator2(NodeParameters np, LengthsIterator ls, CountIterator it)
          throws IOException {
    super(np, ls, it);

...
public class BM25SIterator6 extends ScoringFunctionIterator implements DeltaScoringIterator {
  ...
  public BM25SIterator6(NodeParameters np, LengthsIterator ls, CountIterator it)
          throws IOException {
    super(np, ls, it);
  ...
  private double score(double count, double length) {
    ...
    return idf * (1+numerator / denominator);
  }

  @Override
  public AnnotatedNode getAnnotatedNode(ScoringContext c) throws IOException {
    String type = "BM25SIterator6";

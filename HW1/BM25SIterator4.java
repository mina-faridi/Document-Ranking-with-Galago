...
public class BM25SIterator4 extends ScoringFunctionIterator implements DeltaScoringIterator {
  ...
  public BM25SIterator4(NodeParameters np, LengthsIterator ls, CountIterator it)
          throws IOException {
    super(np, ls, it);

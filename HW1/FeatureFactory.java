...
public class FeatureFactory {
  ...
  static String[][] sOperatorLookup = {
    ...
    {BM25SIterator1.class.getName(), "BM25SIterator1"},
    {BM25SIterator2.class.getName(), "BM25SIterator2"},
    {BM25SIterator3.class.getName(), "BM25SIterator3"},
    {BM25SIterator4.class.getName(), "BM25SIterator4"},
    {BM25SIterator5.class.getName(), "BM25SIterator5"},
    {BM25SIterator21.class.getName(), "BM25SIterator21"},
    {BM25SIterator22.class.getName(), "BM25SIterator22"},

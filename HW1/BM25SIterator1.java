...
public class BM25SIterator1 extends ScoringFunctionIterator implements DeltaScoringIterator {
  ...
  public BM25SIterator1(NodeParameters np, LengthsIterator ls, CountIterator it)
          throws IOException {
    super(np, ls, it);

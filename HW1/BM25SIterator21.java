...
public class BM25SIterator21 extends ScoringFunctionIterator implements DeltaScoringIterator {
  ...
  public BM25SIterator21(NodeParameters np, LengthsIterator ls, CountIterator it)
          throws IOException {
    super(np, ls, it);
  ...
  private double score(double count, double length) {
    ...
    return count * (numerator/denominator) * (log((1+documentCount)/(df)));

  }

  @Override
  public AnnotatedNode getAnnotatedNode(ScoringContext c) throws IOException {
    String type = "BM25SIterator21";

...
public class BM25SIterator22 extends ScoringFunctionIterator implements DeltaScoringIterator {
  ...
  public BM25SIterator22(NodeParameters np, LengthsIterator ls, CountIterator it)
          throws IOException {
    super(np, ls, it);
  ...
  private double score(double count, double length) {
    ...
    return count*(numerator/denominator)*(log(( documentCount + 1) / (df)));
  }

  @Override
  public AnnotatedNode getAnnotatedNode(ScoringContext c) throws IOException {
    String type = "BM25SIterator22";

...
@RequiredParameters(parameters = {"theta"})
public class AdditiveSmoothing extends ScoringFunctionIterator
  ...
  private final double collectionLengthP;
  ...
  public AdditiveSmoothing(NodeParameters p, LengthsIterator ls, CountIterator it)
    ...
    collectionLengthP=collectionLength;
  ...
  private double dirichletScore(double count, double length) {
    double numerator = count + theta;
    double denominator = length + collectionLengthP;
